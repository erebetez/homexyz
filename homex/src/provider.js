...
class ServiceData extends React.Component {
    ...
    componentDidMount() {
        ...
        socket.addEventListener('message', listenerHandler('devices', data => {
    ...
    render() {
        return (this.props.children(this.state.devices, this.state.states))
    }
}
...
class Events extends React.Component {
    ...
    componentDidMount() {
        this.fetchEvent();
        socket.addEventListener('message', listenerHandler(this.props.select, data => {
            console.log(data);
